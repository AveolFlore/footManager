...
$convoques = $convocationController->index((int) $id);
$resultat  = $resultatController->index((int) $id);
?>
...
<body>
    ...
    <div class="flex">
        ...
        <main class="flex-1 p-4 md:p-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-700">
                                <?php
                                // On crée l'objet formateur (Langue, Style date, Style heure)
                                $formatter = new IntlDateFormatter(
                                    'fr_FR',
                                    IntlDateFormatter::NONE,
                                    IntlDateFormatter::NONE
                                );
                                // On définit le format personnalisé : EEEE (jour), dd (numéro), MMMM (mois)
            ...
            <!-- Saisie résultat (censeur/président uniquement + match publie) -->
            <?php if (
