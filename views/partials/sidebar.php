...
<!-- SIDEBAR -->
<aside id="sidebar"
       class="fixed md:static top-0 left-0 z-50 w-64 min-h-screen bg-gradient-to-b from-green-900 to-green-950 text-white shadow-2xl">

    <!-- HEADER -->
    <div class="px-6 py-6 border-b border-green-800/50">
    ...
    <!-- USER -->
    <div class="px-4 py-5 border-t border-green-800/50">
